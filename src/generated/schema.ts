...
export type ApplicationQuery = {
  ...
  readonly currentWorkspace?: Maybe<Workspace>;
...
export type Column = {
  ...
  readonly isUnique?: Maybe<Scalars['Boolean']>;
  readonly name: Scalars['String'];
  readonly tableId: Scalars['ID'];
};

export type CreateColumnAttributes = {
  readonly dataType: DataTypeEnum;
...
export type Database = {
  ...
  readonly identifier: Scalars['String'];
  readonly name: Scalars['String'];
  readonly tables?: Maybe<ReadonlyArray<Table>>;
};
...
export type Table = {
  ...
  readonly cols?: Maybe<ReadonlyArray<Column>>;
  readonly id: Scalars['ID'];
  readonly identifier: Scalars['String'];
  readonly name: Scalars['String'];
};
...
export type Workspace = {
  ...
  readonly name: Scalars['String'];
  readonly publicApiKey: Scalars['String'];
};
...
export type CreateTableInput = {
  /** A unique identifier for the client performing the mutation. */
  readonly clientMutationId?: InputMaybe<Scalars['String']>;
  readonly columns: ReadonlyArray<CreateColumnAttributes>;
...
export type ColumnFragmentFragment = { readonly __typename?: 'Column', readonly id: string, readonly tableId: string, readonly name: string, readonly identifier: string, readonly dataType: DataTypeEnum, readonly defaultValue?: string, readonly isArray?: boolean, readonly isIndexed?: boolean, readonly isPrimary?: boolean, readonly isUnique?: boolean, readonly isNullable?: boolean };
...
export type CreateColumnMutation = { readonly __typename?: 'ApplicationMutation', readonly createColumn?: { readonly __typename?: 'Column', readonly id: string, readonly tableId: string, readonly name: string, readonly identifier: string, readonly dataType: DataTypeEnum, readonly defaultValue?: string, readonly isArray?: boolean, readonly isIndexed?: boolean, readonly isPrimary?: boolean, readonly isUnique?: boolean, readonly isNullable?: boolean } };
...
export type CreateFolderMutation = { readonly __typename?: 'ApplicationMutation', readonly createFolder?: { readonly __typename?: 'Folder', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly createdAt: any, readonly updatedAt: any } };
...
export type CreateTableMutation = { readonly __typename?: 'ApplicationMutation', readonly createTable?: { readonly __typename?: 'Table', readonly id: string, readonly name: string, readonly identifier: string, readonly cols?: ReadonlyArray<{ readonly __typename?: 'Column', readonly id: string, readonly tableId: string, readonly name: string, readonly identifier: string, readonly dataType: DataTypeEnum, readonly defaultValue?: string, readonly isArray?: boolean, readonly isIndexed?: boolean, readonly isPrimary?: boolean, readonly isUnique?: boolean, readonly isNullable?: boolean }> } };
...
export type CurrentWorkspaceQuery = { readonly __typename?: 'ApplicationQuery', readonly currentWorkspace?: { readonly __typename?: 'Workspace', readonly id: string, readonly name: string, readonly identifier: string, readonly logo?: string, readonly publicApiKey: string, readonly environments?: ReadonlyArray<{ readonly __typename?: 'Environment', readonly id: string, readonly name: string, readonly identifier: string }> } };

export type DatabaseFragmentFragment = { readonly __typename?: 'Database', readonly id: string, readonly name: string, readonly identifier: string, readonly tables?: ReadonlyArray<{ readonly __typename?: 'Table', readonly id: string, readonly name: string, readonly identifier: string, readonly cols?: ReadonlyArray<{ readonly __typename?: 'Column', readonly id: string, readonly tableId: string, readonly name: string, readonly identifier: string, readonly dataType: DataTypeEnum, readonly defaultValue?: string, readonly isArray?: boolean, readonly isIndexed?: boolean, readonly isPrimary?: boolean, readonly isUnique?: boolean, readonly isNullable?: boolean }> }> };
...
export type FileFragmentFragment = { readonly __typename?: 'File', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly fileType: string, readonly createdAt: any, readonly updatedAt: any };

export type FolderFragmentFragment = { readonly __typename?: 'Folder', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly createdAt: any, readonly updatedAt: any };
...
export type StorageDirectoryQuery = { readonly __typename?: 'ApplicationQuery', readonly storageDirectory?: { readonly __typename?: 'Directories', readonly path: string, readonly parentFolder?: { readonly __typename?: 'Folder', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly createdAt: any, readonly updatedAt: any }, readonly bucket: { readonly __typename?: 'Bucket', readonly id: string, readonly name: string, readonly identifier: string }, readonly folders: ReadonlyArray<{ readonly __typename?: 'Folder', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly createdAt: any, readonly updatedAt: any }>, readonly subFolders: ReadonlyArray<{ readonly __typename?: 'Folder', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly createdAt: any, readonly updatedAt: any }>, readonly files: ReadonlyArray<{ readonly __typename?: 'File', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly fileType: string, readonly createdAt: any, readonly updatedAt: any }> } };
...
export type UpdateColumnMutation = { readonly __typename?: 'ApplicationMutation', readonly updateColumn?: { readonly __typename?: 'Column', readonly id: string, readonly tableId: string, readonly name: string, readonly identifier: string, readonly dataType: DataTypeEnum, readonly defaultValue?: string, readonly isArray?: boolean, readonly isIndexed?: boolean, readonly isPrimary?: boolean, readonly isUnique?: boolean, readonly isNullable?: boolean } };
...
export type UpdateFolderMutation = { readonly __typename?: 'ApplicationMutation', readonly updateFolder?: { readonly __typename?: 'Folder', readonly id: string, readonly bucketId: string, readonly name: string, readonly identifier: string, readonly relativePath: string, readonly size: any, readonly createdAt: any, readonly updatedAt: any } };
...
export type WorkspaceFragmentFragment = { readonly __typename?: 'Workspace', readonly id: string, readonly name: string, readonly identifier: string, readonly logo?: string, readonly publicApiKey: string, readonly environments?: ReadonlyArray<{ readonly __typename?: 'Environment', readonly id: string, readonly name: string, readonly identifier: string }> };
 ...
 * });
 */
export function useCurrentWorkspaceQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CurrentWorkspaceQuery, CurrentWorkspaceQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<CurrentWorkspaceQuery, CurrentWorkspaceQueryVariables>(CurrentWorkspaceDocument, options);
      }
export function useCurrentWorkspaceLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CurrentWorkspaceQuery, CurrentWorkspaceQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<CurrentWorkspaceQuery, CurrentWorkspaceQueryVariables>(CurrentWorkspaceDocument, options);
        }
export type CurrentWorkspaceQueryHookResult = ReturnType<typeof useCurrentWorkspaceQuery>;
export type CurrentWorkspaceLazyQueryHookResult = ReturnType<typeof useCurrentWorkspaceLazyQuery>;
